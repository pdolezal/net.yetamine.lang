...
public class TestMappingStorage {
     ...
     */
    protected <K, V> MappingStorage<K, V> create() {
        return MappingStorage.adapt(new HashMap<>());
    }
    ...
    public void testFind() {
        final MappingStorage<Object, Object> f = create();
    ...
    public void testSupplyIfAbsent() {
        final MappingStorage<String, Object> f = create();
